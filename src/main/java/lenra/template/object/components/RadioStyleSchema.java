...
public class RadioStyleSchema {
    ...
    @Expose
    private lenra.template.object.components.CheckboxStyleSchema.VisualDensitySchema visualDensity = lenra.template.object.components.CheckboxStyleSchema.VisualDensitySchema
            .fromValue("standard");
     ...
     * 
     */
    public lenra.template.object.components.CheckboxStyleSchema.VisualDensitySchema getVisualDensity() {
    ...
    public void setVisualDensity(
            lenra.template.object.components.CheckboxStyleSchema.VisualDensitySchema visualDensity) {
