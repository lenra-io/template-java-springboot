...
public class DropdownButtonSchema {
    ...
    @SerializedName("size")
    @Expose
    private lenra.template.object.components.ButtonSchema.SizeSchema size = lenra.template.object.components.ButtonSchema.SizeSchema
            .fromValue("medium");
    /**
     * Style
     * <p>
    ...
    @Expose
    private lenra.template.object.components.ButtonSchema.StyleSchema mainStyle = lenra.template.object.components.ButtonSchema.StyleSchema
            .fromValue("primary");
    /**
     * 
     * (Required)
     ...
     * 
     */
    public lenra.template.object.components.ButtonSchema.SizeSchema getSize() {
        return size;
    }
     ...
     * 
     */
    public void setSize(lenra.template.object.components.ButtonSchema.SizeSchema size) {
        this.size = size;
    }

    public DropdownButtonSchema withSize(lenra.template.object.components.ButtonSchema.SizeSchema size) {
        this.size = size;
        return this;
    }
     ...
     * 
     */
    public lenra.template.object.components.ButtonSchema.StyleSchema getMainStyle() {
        return mainStyle;
    }
     ...
     * 
     */
    public void setMainStyle(lenra.template.object.components.ButtonSchema.StyleSchema mainStyle) {
        this.mainStyle = mainStyle;
    }

    public DropdownButtonSchema withMainStyle(lenra.template.object.components.ButtonSchema.StyleSchema mainStyle) {
        this.mainStyle = mainStyle;
        return this;
    }
