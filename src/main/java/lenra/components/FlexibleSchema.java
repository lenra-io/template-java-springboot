...
public class FlexibleSchema {
    ...
    @SerializedName("fit")
    @Expose
    private FlexibleSchema.FlexFitSchema fit = FlexibleSchema.FlexFitSchema.fromValue("loose");
    /**
     * 
     * (Required)
     * 
     ...
     * 
     */
    public FlexibleSchema.FlexFitSchema getFit() {
        return fit;
    }
     ...
     * 
     */
    public void setFit(FlexibleSchema.FlexFitSchema fit) {
        this.fit = fit;
    }

    public FlexibleSchema withFit(FlexibleSchema.FlexFitSchema fit) {
        this.fit = fit;
        return this;
    }
    ...
    public enum FlexFitSchema {
        ...
        public static FlexibleSchema.FlexFitSchema fromValue(String value) {
            FlexibleSchema.FlexFitSchema constant = CONSTANTS.get(value);
            if (constant == null) {
