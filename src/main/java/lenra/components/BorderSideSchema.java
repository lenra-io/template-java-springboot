...
public class BorderSideSchema {
    ...
    public String toString() {
        ...
        sb.append(BorderSideSchema.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("width");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        return (((this.width == rhs.width)||((this.width!= null)&&this.width.equals(rhs.width)))&&((this.color == rhs.color)||((this.color!= null)&&this.color.equals(rhs.color))));
    }
