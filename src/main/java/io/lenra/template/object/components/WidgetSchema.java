...
public class WidgetSchema {
     ...
     * 
     */
    public void setProps(PropsSchema props) {
        this.props = props;
    }

    public WidgetSchema withProps(PropsSchema props) {
        this.props = props;
        return this;
    }
    ...
    public WidgetSchema withQuery(Query query) {
        this.query = query;
        return this;
    }
