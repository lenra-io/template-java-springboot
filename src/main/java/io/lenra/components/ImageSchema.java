...
public class ImageSchema {
    ...
    @Expose
    private ImageSchema.AlignmentSchema alignment = ImageSchema.AlignmentSchema.fromValue("center");
    /**
     * Rect
     * <p>
    ...
    @Expose
    private ImageSchema.FilterQualitySchema filterQuality = ImageSchema.FilterQualitySchema.fromValue("low");
    /**
     * Box Fit
     * <p>
     ...
     * 
     */
    public ImageSchema.AlignmentSchema getAlignment() {
        return alignment;
    }
     ...
     * 
     */
    public void setAlignment(ImageSchema.AlignmentSchema alignment) {
        this.alignment = alignment;
    }

    public ImageSchema withAlignment(ImageSchema.AlignmentSchema alignment) {
        this.alignment = alignment;
        return this;
    }
     ...
     * 
     */
    public ImageSchema.FilterQualitySchema getFilterQuality() {
     ...
     * 
     */
    public void setFilterQuality(ImageSchema.FilterQualitySchema filterQuality) {
        this.filterQuality = filterQuality;
    }

    public ImageSchema withFilterQuality(ImageSchema.FilterQualitySchema filterQuality) {
        this.filterQuality = filterQuality;
        return this;
    }
     ...
     * 
     */
    public ImageSchema.BoxFitSchema getFit() {
        return fit;
    }
     ...
     * 
     */
    public void setFit(ImageSchema.BoxFitSchema fit) {
        this.fit = fit;
    }

    public ImageSchema withFit(ImageSchema.BoxFitSchema fit) {
        this.fit = fit;
        return this;
    }
    ...
    public enum AlignmentSchema {
        ...
        public static ImageSchema.AlignmentSchema fromValue(String value) {
            ImageSchema.AlignmentSchema constant = CONSTANTS.get(value);
            if (constant == null) {
    ...
    public enum BoxFitSchema {
        ...
        public static ImageSchema.BoxFitSchema fromValue(String value) {
            ImageSchema.BoxFitSchema constant = CONSTANTS.get(value);
            if (constant == null) {
                throw new IllegalArgumentException(value);
            } else {
                return constant;
    ...
    public enum FilterQualitySchema {
        ...
        public static ImageSchema.FilterQualitySchema fromValue(String value) {
            ImageSchema.FilterQualitySchema constant = CONSTANTS.get(value);
            if (constant == null) {
                throw new IllegalArgumentException(value);
            } else {
                return constant;
