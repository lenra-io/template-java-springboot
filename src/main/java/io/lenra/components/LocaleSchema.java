...
public class LocaleSchema {
    ...
    public String toString() {
        ...
        sb.append(LocaleSchema.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        return ((((this.scriptCode == rhs.scriptCode)||((this.scriptCode!= null)&&this.scriptCode.equals(rhs.scriptCode)))&&((this.languageCode == rhs.languageCode)||((this.languageCode!= null)&&this.languageCode.equals(rhs.languageCode))))&&((this.countryCode == rhs.countryCode)||((this.countryCode!= null)&&this.countryCode.equals(rhs.countryCode))));
    }
