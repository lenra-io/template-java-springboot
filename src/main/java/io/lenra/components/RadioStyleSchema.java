...
public class RadioStyleSchema {
    ...
    @Expose
    private io.lenra.components.CheckboxStyleSchema.VisualDensitySchema visualDensity = io.lenra.components.CheckboxStyleSchema.VisualDensitySchema
            .fromValue("standard");
     ...
     * 
     */
    public io.lenra.components.CheckboxStyleSchema.VisualDensitySchema getVisualDensity() {
     ...
     * 
     */
    public void setVisualDensity(io.lenra.components.CheckboxStyleSchema.VisualDensitySchema visualDensity) {
        this.visualDensity = visualDensity;
    }

    public RadioStyleSchema withVisualDensity(
            io.lenra.components.CheckboxStyleSchema.VisualDensitySchema visualDensity) {
        this.visualDensity = visualDensity;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(RadioStyleSchema.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        return ((((((this.visualDensity == rhs.visualDensity)
