...
public class Menu implements Widget {
        ...
        public Object render(JsonArray data, JsonObject props,
                ...
                child_list.add(new ContainerSchema()
                                .withConstraints(
                                                new BoxConstraintsSchema().withMaxHeight(32.0).withMinHeight(32.0)
                                                                .withMaxWidth(32.0)
                                                                .withMinWidth(32.0))
                ...
                child_list.add(new FlexibleSchema()
                                .withChild(new ContainerSchema()
                                                .withChild(new TextSchema().withValue("Hello World")
                ...
                FlexSchema child = new FlexSchema().withFillParent(true)
